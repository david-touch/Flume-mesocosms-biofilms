...
#data_summary function from 
#https://stackoverflow.com/questions/60999394/how-do-i-incorporate-se-in-place-of-sd-in-my-bar-chart-error-bars-also-how-do
...
#ggrare function from 
#https://github.com/gauravsk/ranacapa/blob/master/R/ggrare.R
